...
if (basename($_SERVER['PHP_SELF']) === basename(__FILE__)) {
  ...
  elseif ($_GET['module'] == 'barang' && $_SESSION['hak_akses'] != 'Kepala Bidang' )  {
  ...
  elseif ($_GET['module'] == 'user' && $_SESSION['hak_akses'] == 'Kepala Bidang') {
     
    include "modules/user/tampil_data.php";
  }
   
  elseif ($_GET['module'] == 'form_entri_user' && $_SESSION['hak_akses'] == 'Kepala Bidang') {
     
    include "modules/user/form_entri.php";
  }
   
  elseif ($_GET['module'] == 'form_ubah_user' && $_SESSION['hak_akses'] == 'Kepala Bidang') {
