        ...
        <div class="table-responsive">
          ...
          <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
            ...
            <tbody>
              ...
              $query = mysqli_query($mysqli, "SELECT a.id_barang, a.nama_barang, a.stok, a.satuan, a.harga, b.nama_satuan
              ...
              while ($data = mysqli_fetch_assoc($query)) { ?>
                ...
                <tr>
                  ...
                  <td width="70" class="text-center">Rp. <?php echo number_format($data['harga'], 0, '', '.'); ?></td>
