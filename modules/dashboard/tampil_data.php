  ...
  if (isset($_GET['pesan'])) {
    ...
    if ($_GET['pesan'] == 1) {
      ...
      echo '<div class="alert alert-notify alert-secondary alert-dismissible fade show" role="alert">
              ...
              <span data-notify="title" class="text-secondary">Halaman ' . $_SESSION['nama_user'] . '</span> 
              <span data-notify="message">Aplikasi Persediaan Barang.</span>
  ...
  <div class="page-inner mt--5">
    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="card-title"><i class="fas fa-info-circle mr-2"></i> Data Persediaan Barang </div>
      </div>
      <div class="card-body">
          ...
          <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
            ...
            <tbody>
              ...
              $query = mysqli_query($mysqli, "SELECT a.id_barang, a.nama_barang, a.jenis, a.stok_minimum, a.stok, a.satuan, b.nama_jenis, c.nama_satuan
                                              ...
                                              WHERE a.jenis ORDER BY a.id_barang ASC")
              ...
              while ($data = mysqli_fetch_assoc($query)) { ?>
                ...
                <tr>
                  ...
                  <td width="70" class="text-center"><?php echo $data['stok']; ?></td>
